    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-lg">
        <div className="relative w-48 h-48 mb-8 flex items-center justify-center">
          <svg className="w-36 h-36 opacity-20" viewBox="0 0 91.33 92.41">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-6xl opacity-60">🔧</div>
        </div>

        <h1 className="text-8xl md:text-9xl font-black text-primary tracking-tighter leading-none mb-4">503</h1>
        <p className="text-xl md:text-2xl font-semibold text-primary/80 mb-2">Servicio en mantenimiento</p>
        <p className="text-base text-primary/50 mb-10 max-w-sm">
          Estamos realizando mejoras para brindarte una mejor experiencia. Vuelve a intentarlo en unos minutos.
        </p>
