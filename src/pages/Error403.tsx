  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-lg">
        ...
        <h1 className="text-8xl md:text-9xl font-black text-primary tracking-tighter leading-none mb-4">403</h1>
        <p className="text-xl md:text-2xl font-semibold text-primary/80 mb-2">Acceso denegado</p>
