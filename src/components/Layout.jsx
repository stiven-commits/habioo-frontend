...
export default function Layout() {
  ...
  // 1. Lógica de Tema y Título de Pestaña Dinámico
  useEffect(() => {
    ...
    // Cambia el nombre de la pestaña en el navegador
  ...
  // Función para pintar el menú activo
  const navClass = (path) => location.pathname === path 
  ...
  return (
    <div className="min-h-screen bg-donezo-bg dark:bg-donezo-dark-bg font-sans flex transition-colors duration-300">
      ...
      <aside className="w-64 bg-white dark:bg-donezo-card-dark shadow-lg hidden md:flex flex-col p-6 rounded-r-3xl border-r border-gray-100 dark:border-gray-800">
        ...
        <nav className="flex flex-col gap-2 flex-1">
          ...
          {userRole === 'Administrador' && (
            <>
              <div className="text-xs font-bold text-gray-400 mt-4 mb-2 uppercase tracking-wider">Administración</div>
      ...
      <main className="flex-1 p-8 overflow-y-auto h-screen">
        ...
        {/* MAGIA DE REACT ROUTER: Aquí se inyecta la sección según la URL */}
